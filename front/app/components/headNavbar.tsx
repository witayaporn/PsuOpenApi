            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="flex space-x-1">
                    ...
                    <a 
                        ...
                        style={{backgroundColor: router ==  "/home" ? "rgb(229 231 235)": ""}}
                    >
                    ...
                    <a 
                        href="/subjectSearch" 
                        className="hidden lg:flex text-blue-950 px-3 items-center space-x-2 rounded-lg hover:bg-gray-200"
                        style={{backgroundColor: router ==  "/subjectSearch" ? "rgb(229 231 235)": ""}}
                    >
                    ...
                    <a 
                        href="/mapSearch" 
                        className="hidden lg:flex text-blue-950 px-3 items-center space-x-2 rounded-lg hover:bg-gray-200"
                        style={{backgroundColor: router ==  "/mapSearch" ? "rgb(229 231 235)": ""}}
                    >
                    ...
                    <a 
                        href="/plan" 
                        className="hidden lg:flex text-blue-950 px-3 items-center space-x-2 rounded-lg hover:bg-gray-200"
                        style={{backgroundColor: router ==  "/plan" ? "rgb(229 231 235)": ""}}
                    >

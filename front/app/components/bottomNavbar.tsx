        ...
        <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full shadow-lg bottom-4 left-1/2 md:hidden">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto">
                <a 
                    ...
                    style={{color: router == "/home" ? "rgb(23 37 84)": "rgb(156 169 175)"}}
                >
                ...
                <a 
                    ...
                    style={{color: router == "/subjectSearch" ? "rgb(23 37 84)": "rgb(156 169 175)"}}
                >
                ...
                <a 
                    ...
                    style={{color: router == "/mapSearch" ? "rgb(23 37 84)": "rgb(156 169 175)"}} 
                >
                ...
                <a 
                    ...
                    style={{color: router == "/plan" ? "rgb(23 37 84)": "rgb(156 169 175)"}}
                >

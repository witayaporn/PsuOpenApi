...
async def update_comment(xSubjectId: int, request: Request, comment: CommentUpdate = Body(...)):
...
async def delete_comment(xSubjectId: int, request: Request, response: Response):
